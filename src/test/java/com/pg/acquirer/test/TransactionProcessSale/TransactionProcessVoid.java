...
public class TransactionProcessVoid {
	...
	masterRequestData.put("transactionType", "VOID");
    ...
    @Test(description = "Verify whether user is able to perform VOID Transaction by passing valid VISA card details.")
    public void API_VOID_TC_001() {
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing valid MasterCard card details.")
    public void API_VOID_TC_002() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing valid American Express card details.")
    public void API_VOID_TC_003() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing valid Diner's Club card details.")
    public void API_VOID_TC_004() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing valid Discover card details.")
    public void API_VOID_TC_005() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing valid JCB card details.")
    public void API_VOID_TC_006() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing Visa Card type with Card Number more than maximum length ")
    public void API_VOID_TC_007() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing Visa Card type with Card Number less than minimum length ")
    public void API_VOID_TC_008() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","VI");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing MasterCard Card type with Card Number more than maximum length ")
    public void API_VOID_TC_009() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","MC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing MasterCard Card type with Card Number less than minimum length ")
    public void API_VOID_TC_010() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","VI");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing American Express Card type with Card Number more than maximum length ")
    public void API_VOID_TC_011() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","AX");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing American Express Card type with Card Number less than minimum length")
    public void API_VOID_TC_012() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","AX");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing Diner's Club Card type with Card Number more than maximum length ")
    public void API_VOID_TC_013() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","DC");
	requestData.replace("cardNumber","30000000000004");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing Diner's Club Card type with Card Number less than minimum length ")
    public void API_VOID_TC_014() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","DC");
	requestData.replace("cardNumber","3400009123");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing Discover Card type with Card Number more than maximum length")
    public void API_VOID_TC_015() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","DISCOVER");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing Discover Card type with Card Number less than minimum length ")
    public void API_VOID_TC_016() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","DISCOVER");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing JCB Card type with Card Number more than maximum length ")
    public void API_VOID_TC_017() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","JCB");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL VOID Transaction by passing JCB Card type with Card Number less than minimum length ")
    public void API_VOID_TC_018() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","JCB");
    ...
    /*
     * @Test(description =
     * "Verify the server throws appropriate error message, when user enters less than minimum length data in posEntryMode as part of the request."
     * ) public void API_VOID_TC_021() { Map<String, String> requestData = new
     * HashMap<String, String>(); requestData.putAll(masterRequestData);
     * requestData.replace("posEntryMode","0");
     * requestData.put("txnRefNumber",HitService.getResponseValue(txnRefNumber, "txnRefNumber")); JsonObject saleJsonObj =
     ...
     * Constants.ERRORCODE).equalsIgnoreCase("TXN_0140"));
     * Assert.assertTrue(HitService.getResponseValue(response,
     * Constants.ERRORMESSAGE).equalsIgnoreCase("Invalid pos entry mode")); }
     */
    ...
    public void API_VOID_TC_070() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("expDate","0721");
	requestData.put("txnRefNumber",HitService.getResponseValue(txnRefNumber, "txnRefNumber"));
	JsonObject saleJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(saleJsonObj.toString(), endURL);
	System.out.println(response.asString());
    ...
    public void API_VOID_TC_097() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("processingCode","@20000");
	requestData.put("txnRefNumber",HitService.getResponseValue(txnRefNumber, "txnRefNumber"));
	JsonObject saleJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(saleJsonObj.toString(), endURL);
	System.out.println(response.asString());
    ...
    public void API_VOID_TC_100() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("processingCode","02000000");
	requestData.put("txnRefNumber",HitService.getResponseValue(txnRefNumber, "txnRefNumber"));
	JsonObject saleJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(saleJsonObj.toString(), endURL);
	System.out.println(response.asString());
    ...
    public void API_VOID_TC_124() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("posConditionCode","001");
	requestData.put("txnRefNumber",HitService.getResponseValue(txnRefNumber, "txnRefNumber"));
	JsonObject saleJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(saleJsonObj.toString(), endURL);
	System.out.println(response.asString());
    ...
    @Test(description = "Verify the server throws appropriate error message, when user pass txnRefNumber with value which already voided.")
    public void API_VOID_TC_134() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.put("txnRefNumber","297992");
	JsonObject saleJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(saleJsonObj.toString(), endURL);
	System.out.println(response.asString());
	Reporter.log("Response : " + response.asString());
    ...
    @Test(description = "Verify the server throws appropriate error message, when user pass txnAmount with different value for which sale txn is not performed")
    public void API_VOID_TC_135() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.put("txnRefNumber","297993");
	JsonObject saleJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(saleJsonObj.toString(), endURL);
	System.out.println(response.asString());
	Reporter.log("Response : " + response.asString());
