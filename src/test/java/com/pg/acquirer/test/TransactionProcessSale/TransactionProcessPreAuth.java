...
public class TransactionProcessPreAuth {
	...
	masterRequestData.put("transactionType", "PREAUTH");
    ...
    @Test(groups="sanity",description = "Verify whether user is able to perform PREAUTH Transaction by passing valid VISA card details.")
    public void API_PREAUTH_TC_001() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
	System.out.println(preAuthJsonObj.toString());
	Response response = HitService.getJSONResponse(preAuthJsonObj.toString(), endURL);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing valid MasterCard card details.")
    public void API_PREAUTH_TC_002() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing valid American Express card details.")
    public void API_PREAUTH_TC_003() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing valid Diner's Club card details.")
    public void API_PREAUTH_TC_004() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing valid Discover card details.")
    public void API_PREAUTH_TC_005() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "DC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing valid JCB card details.")
    public void API_PREAUTH_TC_006() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing Visa Card type with Card Number more than maximum length ")
    public void API_PREAUTH_TC_007() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing Visa Card type with Card Number less than minimum length")
    public void API_PREAUTH_TC_008() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing MasterCard Card type with Card Number more than maximum length ")
    public void API_PREAUTH_TC_009() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "MC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing MasterCard Card type with Card Number less than minimum length ")
    public void API_PREAUTH_TC_010() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "MC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing American Express Card type with Card Number more than maximum length ")
    public void API_PREAUTH_TC_011() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "AX");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing American Express Card type with Card Number less than minimum length ")
    public void API_PREAUTH_TC_012() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "AX");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing Diner's Club Card type with Card Number more than maximum length ")
    public void API_PREAUTH_TC_013() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "DC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing Diner's Club Card type with Card Number less than minimum length ")
    public void API_PREAUTH_TC_014() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "DC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing Discover Card type with Card Number more than maximum length ")
    public void API_PREAUTH_TC_015() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "DC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing Discover Card type with Card Number less than minimum length ")
    public void API_PREAUTH_TC_016() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "DC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing JCB Card type with Card Number more than maximum length")
    public void API_PREAUTH_TC_017() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "JCB");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL PREAUTH Transaction by passing JCB Card type with Card Number less than minimum length ")
    public void API_PREAUTH_TC_018() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "JCB");
    ...
    public void API_PREAUTH_TC_019() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_020() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_021() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_022() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_023() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_024() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_025() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_026() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_027() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_028() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_029() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_030() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_031() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_032() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_033() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_034() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_035() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_036() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_037() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_038() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_039() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_040() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_041() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_042() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_043() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_044() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_045() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_046() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_047() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_048() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_049() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_050() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_051() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","Blank");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_052() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","V");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_053() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.remove("cardType");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_054() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_055() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardNumber","Blank");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_056() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.remove("cardNumber");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_057() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_058() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","MC");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_059() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_060() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","AX");
	requestData.replace("cardNumber","5500000000000004");
    ...
    public void API_PREAUTH_TC_061() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_062() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType","JCB");
	requestData.replace("cardNumber","5500000000000004");
    ...
    public void API_PREAUTH_TC_063() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_064() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("expDate","Blank");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_065() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_066() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_067() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.remove("expDate");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_068() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_069() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_070() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_071() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_072() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.remove("expDate");
	requestData.remove("cvv");
    ...
    public void API_PREAUTH_TC_073() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("expDate","Blank");
	requestData.replace("cvv","Blank");
    ...
    public void API_PREAUTH_TC_074() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_075() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cvv","Blank");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_076() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cvv","34");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_077() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.remove("cvv");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
    ...
    public void API_PREAUTH_TC_078() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    public void API_PREAUTH_TC_079() {
    ...
    public void API_PREAUTH_TC_080() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
	requestData.replace("cvv","3454");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(preAuthJsonObj.toString(), endURL);
    ...
    public void API_PREAUTH_TC_081() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_082() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_083() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_084() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_085() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_086() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_087() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_088() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_089() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_090() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_091() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_092() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_093() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_094() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_095() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_096() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_097() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_098() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_099() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_100() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_101() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_102() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_103() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_104() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
	requestData.replace("currencyCode","84");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(preAuthJsonObj.toString(), endURL);
    ...
    public void API_PREAUTH_TC_105() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_106() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_107() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_108() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_109() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_110() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_111() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
	requestData.replace("sysTraceNum","00001");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(preAuthJsonObj.toString(), endURL);
    ...
    public void API_PREAUTH_TC_112() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_113() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_114() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_115() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_116() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_117() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
	requestData.replace("merchantType","212");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(preAuthJsonObj.toString(), endURL);
    ...
    public void API_PREAUTH_TC_118() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_119() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_120() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_121() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_122() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_123() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
	requestData.replace("posConditionCode","0");
	JsonObject preAuthJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(preAuthJsonObj.toString(), endURL);
    ...
    public void API_PREAUTH_TC_124() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_125() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_126() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_128() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
    ...
    public void API_PREAUTH_TC_129() {
	Map<String, String> requestData = new HashMap<String, String>(masterRequestData);
