...
public class TransactionProcessSale {
    ...
    public Response generateProcessSaleTransactionResponse() {
	dataInit();
	...
	masterRequestData.put("transactionType", "SALE");
    ...
    @Test(description = "Verify whether user is able to perform SALE Transaction by passing valid VISA card details.")
    public void API_SALE_TC_001() {
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing valid MasterCard card details.")
    public void API_SALE_TC_002() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing valid American Express card details.")
    public void API_SALE_TC_003() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing valid Diner's Club card details.")
    public void API_SALE_TC_004() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing valid Discover card details.")
    public void API_SALE_TC_005() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "DC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing valid JCB card details.")
    public void API_SALE_TC_006() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing Visa Card type with Card Number more than maximum length")
    public void API_SALE_TC_007() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing Visa Card type with Card Number less than minimum length")
    public void API_SALE_TC_008() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "VI");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing MasterCard Card type with Card Number more than maximum length")
    public void API_SALE_TC_009() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "MC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing MasterCard Card type with Card Number less than minimum length ")
    public void API_SALE_TC_010() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "MC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing American Express Card type with Card Number more than maximum length")
    public void API_SALE_TC_011() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing American Express Card type with Card Number less than minimum length ")
    public void API_SALE_TC_012() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing Diner's Club Card type with Card Number more than maximum length")
    public void API_SALE_TC_013() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "DC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing Discover Card type with Card Number more than maximum length ")
    public void API_SALE_TC_015() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "DC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing Discover Card type with Card Number less than minimum length")
    public void API_SALE_TC_016() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "DC");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing JCB Card type with Card Number more than maximum length")
    public void API_SALE_TC_017() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "JCB");
    ...
    @Test(description = "Verify whether user is able to perform MANUAL SALE Transaction by passing JCB Card type with Card Number less than minimum length")
    public void API_SALE_TC_018() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("cardType", "JCB");
    ...
    public void API_SALE_TC_024() {
	Map<String, String> requestData = new HashMap<String, String>();
	requestData.putAll(masterRequestData);
	requestData.replace("posEntryMode", "NO_PARAM");
	JsonObject saleJsonObj = RequestBuilders.buildRequest(requestData);
	Response response = HitService.getJSONResponse(saleJsonObj.toString(), endURL);
	System.out.println(response.asString());
	Reporter.log("Response : " + response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters invalid MTI as part of the request."
      ) public void API_SALE_TC_093() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("mti","020$"); JsonObject saleJsonObj =
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not enter value for MTI as part of the request."
      ) public void API_SALE_TC_094() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("mti","Blank"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString());
      Reporter.log("Response :" + response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters less than minimum length data in MTI as part of the request."
      ) public void API_SALE_TC_095() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("mti","020"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters more than maximum length data in MTI as part of the request."
      ) public void API_SALE_TC_096() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("mti","0200000"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not pass MTI parameter as part of the request."
      ) public void API_SALE_TC_097() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.remove("mti"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user pass  non-existing MTI  as part of the request."
      ) public void API_SALE_TC_098() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("mti","1200"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user pass  MTI as zeros as part of the request."
      ) public void API_SALE_TC_099() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("mti","0000"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters invalid processingCode as part of the request."
      ) public void API_SALE_TC_100() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("processingCode","0000*0"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not enter value for processingCode as part of the request."
      ) public void API_SALE_TC_101() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("processingCode","Blank"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters less than minimum length data in processingCode as part of the request."
      ) public void API_SALE_TC_102() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("processingCode","00000"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters more than maximum length data in processingCode as part of the request."
      ) public void API_SALE_TC_103() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("processingCode","0000090"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not pass processingCode parameter as part of the request."
      ) public void API_SALE_TC_104() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.remove("processingCode"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user pass  non-existing processingCode  as part of the request."
      ) public void API_SALE_TC_105() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("processingCode","123456"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user pass transactionType as VOID or AUTH for posentrymode 011, MTI 0200, processingcode 000000 as part of the request."
      ) public void API_SALE_TC_106() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("transactionType","AUTH"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters invalid currencyCode as part of the request."
      ) public void API_SALE_TC_107() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("currencyCode","84#"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not enter value for currencyCode as part of the request."
      ) public void API_SALE_TC_108() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("currencyCode","Blank"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters less than minimum length data in currencyCode as part of the request."
      ) public void API_SALE_TC_109() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("currencyCode","84"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters more than maximum length data in currencyCode as part of the request."
      ) public void API_SALE_TC_110() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("currencyCode","8401"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not pass currencyCode parameter as part of the request."
      ) public void API_SALE_TC_111() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.remove("currencyCode"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user pass  currencyCode vaue as zeros as part of the request."
      ) public void API_SALE_TC_112() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("currencyCode","000"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user pass  non-existing currencyCode as part of the request."
      ) public void API_SALE_TC_113() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("currencyCode","123"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters invalid sysTraceNum as part of the request."
      ) public void API_SALE_TC_114() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("sysTraceNum","00001#"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not enter value for sysTraceNum as part of the request."
      ) public void API_SALE_TC_115() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("sysTraceNum","Blank"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters less than minimum length data in sysTraceNum as part of the request."
      ) public void API_SALE_TC_116() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("sysTraceNum","1"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters more than maximum length data in sysTraceNum as part of the request."
      ) public void API_SALE_TC_117() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("sysTraceNum","000010222222"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not pass sysTraceNum parameter as part of the request."
      ) public void API_SALE_TC_118() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.remove("sysTraceNum"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user pass  sysTraceNum vaue as zeros as part of the request."
      ) public void API_SALE_TC_119() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("sysTraceNum","000000"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters invalid merchantType as part of the request."
      ) public void API_SALE_TC_120() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("merchantType","*000"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not enter value for merchantType as part of the request."
      ) public void API_SALE_TC_121() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("merchantType","Blank"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters less than minimum length data in merchantType as part of the request."
      ) public void API_SALE_TC_122() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("merchantType","1"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user enters more than maximum length data in merchantType as part of the request."
      ) public void API_SALE_TC_123() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("merchantType","300034234"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user does not pass merchantType parameter as part of the request."
      ) public void API_SALE_TC_124() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.remove("merchantType"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
    ...
    @Test(description =
      "Verify the server throws appropriate error message, when user pass merchantType value as zeros as part of the request."
      ) public void API_SALE_TC_125() { Map<String, String> requestData = new
      HashMap<String, String>(); requestData.putAll(masterRequestData);
      requestData.replace("merchantType","0000"); JsonObject saleJsonObj =
      RequestBuilders.buildRequest(requestData); Response response =
      HitService.getJSONResponse(saleJsonObj.toString(), endURL);
      System.out.println(response.asString()); Reporter.log("Response : " +
      response.asString());
